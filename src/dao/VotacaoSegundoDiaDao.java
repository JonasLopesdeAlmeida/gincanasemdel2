...
public class VotacaoSegundoDiaDao extends Conecta  {
	...
	public void gravar(VotacaoSegundoDia v2 )
	{
...

		{
			...
			stm = con.prepareStatement("insert into votacao_2_dia(grupod_1,grupod_2, grupoe_1,grupoe_2, grupof_1,grupof_2 ,data_votacao_2_dia, ip_votacao_2_dia )values(?,?,?,?,?,?,?,?)");
			...
			stm.setString(8, v2.getIp_votacao_2_dia());
			stm.execute();
			stm.close();                             
			con.close();
		}
