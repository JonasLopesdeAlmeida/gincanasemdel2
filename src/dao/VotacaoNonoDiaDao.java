...
public class VotacaoNonoDiaDao extends Conecta  {
	...
	public void gravar(VotacaoNonoDia v9 )
	{
...

		{
			...
			stm = con.prepareStatement("insert into votacao_9_dia(grupog_1,grupog_2, grupoh_1, grupoh_2, grupoi_1, grupoi_2 , data_votacao_9_dia, ip_votacao_9_dia )values(?,?,?,?,?,?,?,?)");
			...
			stm.setString(8, v9.getIp_votacao_9_dia());
			stm.execute();
			stm.close();                             
			con.close();
		}
