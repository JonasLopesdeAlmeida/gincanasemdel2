...
/**
 * Servlet implementation class ServerVotacaoNonoDia
 */
public class ServerVotacaoNonoDia extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServerVotacaoNonoDia() {
        super();
    ...
    /**
   	...
   	private void doService(HttpServletResponse response, HttpServletRequest request) throws Exception {
  		...
  		String grupoi_2 = request.getParameter("grupoi_2");
   		...
   		String ip_votacao_9_dia = request.getHeader("x-forwarded-for");
   		//pegando ip reverso mesmo se estiver por tras de proxy.
   		if (ip_votacao_9_dia == null) {
   			ip_votacao_9_dia = request.getHeader("X_FORWARDED_FOR");
   		    if (ip_votacao_9_dia == null){
   		    	ip_votacao_9_dia = request.getRemoteAddr();
   		    }
   		}
   		
        System.out.println(ip_votacao_9_dia);
  		...
  		v9.setGrupoi_2(grupoi_2);
   		...
   		v9.setIp_votacao_9_dia(ip_votacao_9_dia);
