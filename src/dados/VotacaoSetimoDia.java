...
public class VotacaoSetimoDia  implements Serializable {
	...
	private String grupoa_1,grupoa_2, grupob_1,grupob_2, grupoc_1,grupoc_2 ,data_votacao_7_dia;
	...
	public VotacaoSetimoDia(int id_votacao_7, String grupoa_1, String grupoa_2, String grupob_1, String grupob_2,
			String grupoc_1, String grupoc_2, String data_votacao_7_dia) {
		super();
	...
	public void setId_votacao_4(int id_votacao_7) {
		this.id_votacao_7 = id_votacao_7;
	}
