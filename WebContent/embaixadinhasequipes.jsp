    ...
    <div class="container"> <a class="navbar-brand text-primary" href="index.html">
      ...
      <div class="collapse navbar-collapse" id="navbar4">
        <ul class="navbar-nav ml-auto text-uppercase font-weight-bold negrita fonte_menu">
          <li class="nav-item"> <a class="nav-link" href="#embaixad">Embaixadinhas</a> </li>
          <li class="nav-item"> <a class="nav-link" href="#regras">Regras</a> </li>
        </ul>
      </div>
    </div>
  </nav>
  <div class="py-2" id="embaixad">
    <div class="container">
      <div class="row">
        <div class="bg-white mr-auto col-md-12">
          <h1 class="text-danger font-weight-bold">Desafio das embaixadinhas style</h1>
          <p class="mb-3 lead">Assista e curta a sua embaixadinha preferida.</p>
        </div>
      </div>
    </div>
  </div>
  <div class="py-3" id="videos">
    <div class="container">
      <div class="row">
        <div class="col-md-6 p-3">
          <div class="row">
            <div class="col-md-12">
              <h3 class="text-center">Categoria: <span class="text-secondary font-weight-bold">Masculino</span></h3>
            </div>
          </div>
          <div class="row">
        ...
        <div class="col-md-6 p-3">
          <div class="row">
            <div class="col-md-12">
              <h3 class="text-center">Categoria: <span class="text-danger font-weight-bold">Feminino</span></h3>
            </div>
          </div>
          <div class="row">
            <div class="col-md-5 p-3">
