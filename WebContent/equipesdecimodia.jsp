	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar4">
			<ul
				...
				<li class="nav-item"><a class="nav-link" href="equipesnonodia.jsp">9ª dia</a>
				</li>	
				<li class="nav-item"><a class="nav-link" href="#equipes">EQUIPES</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="#regras">Regras</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="equipesdecimoprimeirodia.jsp">11ª dia de votação</a>
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="bg-white mr-auto col-md-12">
					<h1 class="text-danger font-weight-bold">Campeonato de votação - 10ª dia </h1>
		...
		<div class="container">
			...
			<div class="row negrita">
				<div class="col-md-8 mx-auto">
					<form method="post" action="ServerVotacaoDecimoDia">
						<div class="form-group">
							<div class="form-row">
...

											{
												...
												try {
													...
													ps = con.prepareStatement(
															"select count(*) AS contaGapara from votacao_10_dia where grupoa_1 = 'GAPARA(Roberto Costa)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
								...
								<div class="col-md-5 p-3 text-center">
									<input type="hidden" name="data_votacao_10_dia" value="<%=dataStr%>">
										...
										<%
											{
												...
												try {
													...
													con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
															"252107");
													ps = con.prepareStatement(
															"select count(*) AS contaJardim from votacao_10_dia where grupoa_1 = 'JARDIM AMERICA(José Carlos Ribeiro)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
											...
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaAurora from votacao_10_dia where grupoa_2 = 'AURORA(Eduardo Verde)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
											...
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaSalina from votacao_10_dia where grupoa_2 = 'SALINA DO SACAVEM(Ritchee Cleidmam)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
												...
												<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaSao from votacao_10_dia where grupob_1 = 'SÃO CRISTOVÃO(Carlos Braga)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
												...
												<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaMauro from votacao_10_dia where grupob_1 = 'MAURO FECURY(José Matias)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
													...
													<%
														{
															...
															try {
																...
																con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																		"252107");
																ps = con.prepareStatement(
																		"select count(*) AS contaSanta2 from votacao_10_dia where grupob_2 = 'SANTA CRUZ(Antonio Rubens)'");
																rs = ps.executeQuery();
																rs.next();
																rs = ps.executeQuery();
													...
													<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaCohab from votacao_10_dia where grupob_2 = 'COHAB(Arnaldo Peixoto)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
