		...
		<div class="container">
			<div class="row">
				<div class="bg-white mr-auto col-md-12">
					<h1 class="text-danger font-weight-bold">Campeonato de votação - 1ª dia </h1>
		...
		<div class="container">
			...
			<div class="row negrita">
				<div class="col-md-8 mx-auto">
					<form method="post" action="ServerVotacao">
							...
							<div class="form-row">
...

											{
												...
												try {
													...
													ps = con.prepareStatement(
															"select count(*) AS contaBacanga from votacao where grupoa_1 = 'BACANGA (Edmilson França)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
								...
								<div class="col-md-5 p-3 text-center">
									...
									<div class="progress">
										<%
											{
												...
												try {
													...
													con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
															"252107");
													ps = con.prepareStatement(
															"select count(*) AS contaAurora from votacao where grupoa_1 = 'AURORA (Eduardo Verde)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
										...
										<div class="progress-bar" role="progressbar" aria-valuemin="0"
											aria-valuemax="100"><%=rs.getString("contaAurora")%></div>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="form-row">
									<div class="col-md-5 p-3 text-center">
										<input class="form-check-input" type="radio" name="grupoa_2"
											value="JARDIM AMERICA (José Carlos Ribeiro)">JARDIM
										AMERICA (José Carlos Ribeiro)<br>
										<div class="progress">
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaJardim from votacao where grupoa_2 = 'JARDIM AMERICA (José Carlos Ribeiro)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
									...
									<div class="col-md-5 p-3 text-center">
										...
										<input class="form-check-input" type="radio" name="grupoa_2"
											value="SALINA DO SACAVEM (Ritchee Cleidmam)">SALINA
										DO SACAVEM (Ritchee Cleidmam)<br>
										<div class="progress">
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaSalina from votacao where grupoa_2 = 'SALINA DO SACAVEM (Ritchee Cleidmam)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
								...
								<div class="form-group">
									<div class="form-row">
												...
												<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaTuru from votacao where grupob_1 = 'TURU (Alerrandro Barbosa)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
										...
										<div class="col-md-5 p-3 text-center">
											...
											<input class="form-check-input" type="radio" name="grupob_1"
												value="SANTA CRUZ (Antonio Rubens)">SANTA CRUZ
											(Antonio Rubens)<br>
											<div class="progress">
												<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaSantaCruz from votacao where grupob_1 = 'SANTA CRUZ (Antonio Rubens)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
										...
										<div class="form-row">
											<div class="col-md-5 p-3 text-center">
												<input class="form-check-input" type="radio" name="grupob_2"
													value="SÃO CRISTOVÃO (Carlos Braga)">SÃO CRISTOVÃO
												(Carlos Braga)<br>
												<div class="progress">
													<%
														{
															...
															try {
																...
																con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																		"252107");
																ps = con.prepareStatement(
																		"select count(*) AS contaSaoCristovao from votacao where grupob_2 = 'SÃO CRISTOVÃO (Carlos Braga)'");
																rs = ps.executeQuery();
																rs.next();
																rs = ps.executeQuery();
											...
											<div class="col-md-5 p-3 text-center">
												...
												<input class="form-check-input" type="radio" name="grupob_2"
													value="COHAB (Arnaldo Peixoto)">COHAB (Arnaldo
												Peixoto)<br>
												<div class="progress">
													<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaCohab from votacao where grupob_2 = 'COHAB (Arnaldo Peixoto)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
											...
											<div class="form-row">
												...
												<div class="col-md-5 p-3 text-center">
													<input class="form-check-input" type="radio"
														name="grupoc_1"
														value="PQ BOM MENINO (Evandro Lima)">PQ
													BOM MENINO (Evandro Lima)<br>
													<div class="progress">
														<%
															{
																...
																try {
																	...
																	con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																			"252107");
																	ps = con.prepareStatement(
																			"select count(*) AS contaParque from votacao where grupoc_1 = 'PQ BOM MENINO (Evandro Lima)'");
																	rs = ps.executeQuery();
																	rs.next();
																	rs = ps.executeQuery();
												...
												<div class="col-md-5 p-3 text-center">
													...
													<input class="form-check-input" type="radio"
														name="grupoc_1"
														value="ANJO DA GUARDA (Jacques Lopes-Botão)">ANJO
													DA GUARDA (Jacques Lopes-Botão)<br>
													<div class="progress">
														<%
															{
																...
																try {
																	...
																	con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																			"252107");
																	ps = con.prepareStatement(
																			"select count(*) AS contaAnjo from votacao where grupoc_1 = 'ANJO DA GUARDA (Jacques Lopes-Botão)'");
																	rs = ps.executeQuery();
																	rs.next();
																	rs = ps.executeQuery();
											...
											<div class="form-group">
												<div class="form-row">
													<div class="col-md-5 p-3 text-center">
														<input class="form-check-input" type="radio"
															name="grupoc_2"
															value="BOM JESUS (Ronilson Mendes)">BOM
														JESUS (Ronilson Mendes)<br>
														<div class="progress">
															<%
																{
																	...
																	try {
																		...
																		con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																				"252107");
																		ps = con.prepareStatement(
																				"select count(*) AS contaBom from votacao where grupoc_2 = 'BOM JESUS (Ronilson Mendes)'");
																		rs = ps.executeQuery();
																		rs.next();
																		rs = ps.executeQuery();
													...
													<div class="col-md-5 p-3 text-center">
														...
														<input class="form-check-input" type="radio"
															name="grupoc_2"
															value="ITAPERA (Rosmarindo)">ITAPERA
														(Rosmarindo)<br>
														<div class="progress">
															<%
																{
																	...
																	try {
																		...
																		con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																				"252107");
																		ps = con.prepareStatement(
																				"select count(*) AS contaIta from votacao where grupoc_2 = 'ITAPERA (Rosmarindo)'");
																		rs = ps.executeQuery();
																		rs.next();
																		rs = ps.executeQuery();
															...
															<div class="progress-bar" role="progressbar"
																aria-valuemin="0" aria-valuemax="100"><%=rs.getString("contaIta")%></div>
														</div>
													</div>
