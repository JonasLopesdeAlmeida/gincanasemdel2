	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar4">
			<ul
				...
				<li class="nav-item"><a class="nav-link" href="equipesoitavodia.jsp">8ª dia</a>
				</li>	
				<li class="nav-item"><a class="nav-link" href="#equipes">EQUIPES</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="#regras">Regras</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="equipesdecimodia.jsp">10ª dia de votação</a>
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="bg-white mr-auto col-md-12">
					<h1 class="text-danger font-weight-bold">Campeonato de votação - 9ª dia </h1>
		...
		<div class="container">
			...
			<div class="row negrita">
				<div class="col-md-8 mx-auto">
					<form method="post" action="ServerVotacaoNonoDia">
						<div class="form-group">
							<div class="form-row">
...

											{
												...
												try {
													...
													ps = con.prepareStatement(
															"select count(*) AS contaVila from votacao_9_dia where grupog_1 = 'VILA PALMEIRA(Emerson Viana)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
								...
								<div class="col-md-5 p-3 text-center">
									<input type="hidden" name="data_votacao_9_dia" value="<%=dataStr%>">
									...
									<div class="progress">
										<%
											{
												...
												try {
													...
													con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
															"252107");
													ps = con.prepareStatement(
															"select count(*) AS contaBequimao from votacao_9_dia where grupog_1 = 'BEQUIMÃO(Samir Nunes)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
										...
										<div class="progress-bar" role="progressbar" aria-valuemin="0"
											aria-valuemax="100"><%=rs.getString("contaBequimao")%></div>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="form-row">
											...
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaCidade from votacao_9_dia where grupog_2 = 'CIDADE OLIMPICA(Juvaldir Ferreira)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
									...
									<div class="col-md-5 p-3 text-center">
										...
										<div class="progress">
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaJana2 from votacao_9_dia where grupog_2 = 'JANAINA(Dario Sousa)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
											...
											<div class="progress-bar" role="progressbar"
												aria-valuemin="0" aria-valuemax="100"><%=rs.getString("contaJana2")%></div>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-row">
												...
												<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaJardim from votacao_9_dia where grupoh_1 = 'JARDIM AMERICA(Antônio Luís)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
										...
										<div class="col-md-5 p-3 text-center">
											...
											<div class="progress">
												<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaSanta2 from votacao_9_dia where grupoh_1 = 'SANTA CRUZ(Francineide Alves Neidinha)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
												...
												<div class="progress-bar" role="progressbar"
													aria-valuemin="0" aria-valuemax="100"><%=rs.getString("contaSanta2")%></div>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="form-row">
											<div class="col-md-5 p-3 text-center">
												...
												<div class="progress">
													<%
														{
															...
															try {
																...
																con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																		"252107");
																ps = con.prepareStatement(
																		"select count(*) AS contaVilaIta from votacao_9_dia where grupoh_2 = 'VILA ITAMAR(Raimundo Ferreira)'");
																rs = ps.executeQuery();
																rs.next();
																rs = ps.executeQuery();
													...
													<div class="progress-bar" role="progressbar"
														aria-valuemin="0" aria-valuemax="100"><%=rs.getString("contaVilaIta")%></div>
												</div>
											</div>
													...
													<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaForquilha from votacao_9_dia where grupoh_2 = 'FORQUILHA(Ary de Sousa)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
														...
														<%
															{
																...
																try {
																	...
																	con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																			"252107");
																	ps = con.prepareStatement(
																			"select count(*) AS contaParque from votacao_9_dia where grupoi_1 = 'PQ BOM MENINO(Jaciel Helder Falcão)'");
																	rs = ps.executeQuery();
																	rs.next();
																	rs = ps.executeQuery();
														...
														<%
															{
																...
																try {
																	...
																	con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																			"252107");
																	ps = con.prepareStatement(
																			"select count(*) AS contaBequimao from votacao_9_dia where grupoi_1 = 'BEQUIMÃO(Nerivaldo Frade Nhopi)'");
																	rs = ps.executeQuery();
																	rs.next();
																	rs = ps.executeQuery();
												...
												<div class="form-row">
													<div class="col-md-5 p-3 text-center">
														...
														<div class="progress">
															<%
																{
																	...
																	try {
																		...
																		con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																				"252107");
																		ps = con.prepareStatement(
																				"select count(*) AS contaVicente2 from votacao_9_dia where grupoi_2 = 'VICENTE FIALHO(Sergio Pacheco)'");
																		rs = ps.executeQuery();
																		rs.next();
																		rs = ps.executeQuery();
															...
															<div class="progress-bar" role="progressbar"
																aria-valuemin="0" aria-valuemax="100"><%=rs.getString("contaVicente2")%></div>
														</div>
													</div>
															...
															<%
																{
																	...
																	try {
																		...
																		con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																				"252107");
																		ps = con.prepareStatement(
																				"select count(*) AS contaSacavem from votacao_9_dia where grupoi_2 = 'SACAVEM(José dos Santos Kiriri)'");
																		rs = ps.executeQuery();
																		rs.next();
																		rs = ps.executeQuery();
