...
<body id="topo" class="slowpage">
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar4">
			<ul
				...
				<li class="nav-item"><a class="nav-link" href="#videos">vídeos</a>
				</li>
	...
	<div class="py-5"
		style="background-image: url(imgs/logo3.png); background-position: right bottom; background-size: cover; background-repeat: repeat;">
		<div class="container">
			<div class="row">
				<div class="p-5 bg-white border mr-auto col-md-4">
					<h1 class="text-danger font-weight-bold">Desafio das
						embaixadinhas style</h1>
			...
			<div class="row">
				<div class="col-md-6 p-3">
					<div class="row">
						<div class="col-md-12">
							<h3>
								Categoria: <span class="text-secondary font-weight-bold">Masculino</span>
							</h3>
						</div>
					</div>
							...
							<form method="post" action="ServerVideo">
								<div class="card">
									...
									<div class="card-body text-center">
										...
										<button href="" class="btn btn-dark btn-sm" type="submit"
...

												{
													...
													try {
														...
														ps = con.prepareStatement(
																"select count(*) AS contaBacanga from video where masc_bacanga = 'BACANGA'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
									...
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button id="botaoCurtir" type="submit"
				...
				<div class="col-md-6 p-3">
					<div class="row">
						<div class="col-md-12">
							<h3>
								Categoria: <span class="text-danger font-weight-bold">Feminino</span>
							</h3>
						</div>
					</div>
					<div class="row">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<p class="py-3">
						Na prova do <b>Desafio das embaixadinhas style</b> cada
						“escolinha” inscrita na Gincana poderá indicar até 02
						participantes para representar o seu bairro, sendo um deles do
						sexo feminino e outro do sexo masculino (caso não tenha uma menina
						para representar, a inscrição será feita com apenas 01 menino).
						Neste desafio, cada um dos alunos durante 30 segundos deverão
						tentar realizar movimentos consecutivos sem deixar a bola cair
						(excetuando-se toques com o braço, antebraço ou mãos) sendo
						estimulada a destreza, a criatividade e a habilidade nas manobras
						realizadas.
					</p>
				</div>
			</div>
	...
	<script>
		function atualiza() {
			window.location.href = "embaixadinhascategoria.jsp";
		}
	</script>
