	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar4">
			<ul
				...
				<li class="nav-item"><a class="nav-link" href="equipesdecimodia.jsp">10ª dia</a>
				</li>	
		...
		<div class="container">
			<div class="row">
				<div class="bg-white mr-auto col-md-12">
					<h1 class="text-danger font-weight-bold">Campeonato de votação - 11ª dia </h1>
		...
		<div class="container">
			...
			<div class="row negrita">
				<div class="col-md-8 mx-auto">
					<form method="post" action="ServerVotacaoDecimoPrimeiroDia">
						<div class="form-group">
							<div class="form-row">
...

											{
												...
												try {
													...
													ps = con.prepareStatement(
															"select count(*) AS contaGapara from votacao_11_dia where grupoa_1 = 'GAPARA(Roberto Costa)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
								...
								<div class="col-md-5 p-3 text-center">
									<input type="hidden" name="data_votacao_11_dia" value="<%=dataStr%>">
										...
										<%
											{
												...
												try {
													...
													con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
															"252107");
													ps = con.prepareStatement(
															"select count(*) AS contaAurora from votacao_11_dia where grupoa_1 = 'AURORA(Eduardo Verde)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
								...
								<div class="form-row">
									<div class="col-md-5 p-3 text-center">
										<input class="form-check-input" type="radio" name="grupoa_2"
											value="BACANGA(Edmilson França)">BACANGA (Edmilson França)<br>
										<div class="progress">
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaBacanga from votacao_11_dia where grupoa_2 = 'BACANGA(Edmilson França)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
											...
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaSalina from votacao_11_dia where grupoa_2 = 'SALINA DO SACAVEM(Ritchee Cleidmam)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
												...
												<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaSanta from votacao_11_dia where grupob_1 = 'SANTA CRUZ(Antonio Rubens)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
												...
												<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaMauro from votacao_11_dia where grupob_1 = 'MAURO FECURY(José Matias)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
										...
										<div class="form-row">
											<div class="col-md-5 p-3 text-center">
												<input class="form-check-input" type="radio" name="grupob_2"
													value="TURU(Alerrandro Barbosa)">TURU (Alerrandro Barbosa)<br>
												<div class="progress">
													<%
														{
															...
															try {
																...
																con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																		"252107");
																ps = con.prepareStatement(
																		"select count(*) AS contaTuru2 from votacao_11_dia where grupob_2 = 'TURU(Alerrandro Barbosa)'");
																rs = ps.executeQuery();
																rs.next();
																rs = ps.executeQuery();
													...
													<div class="progress-bar" role="progressbar"
														aria-valuemin="0" aria-valuemax="100"><%=rs.getString("contaTuru2")%></div>
												</div>
											</div>
											...
											<div class="col-md-5 p-3 text-center">
													...
													<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaCohab2 from votacao_11_dia where grupob_2 = 'COHAB(Arnaldo Peixoto)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
												...
												<div class="progress-bar" role="progressbar"
													aria-valuemin="0" aria-valuemax="100"><%=rs.getString("contaCohab2")%></div>
											</div>
										</div>
									</div>
								</div>
