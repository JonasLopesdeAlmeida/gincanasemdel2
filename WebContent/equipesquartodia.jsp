	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar4">
			<ul
				...
				<li class="nav-item"><a class="nav-link" href="equipesterceirodia.jsp">3ª dia</a>
				</li>	
				<li class="nav-item"><a class="nav-link" href="#equipes">EQUIPES</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="#regras">Regras</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="equipesquintodia.jsp">5ª dia de votação</a>
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="bg-white mr-auto col-md-12">
					<h1 class="text-danger font-weight-bold">Campeonato de votação - 4ª dia </h1>
		...
		<div class="container">
			...
			<div class="row negrita">
				<div class="col-md-8 mx-auto">
					<form method="post" action="ServerVotacaoQuartoDia">
						<div class="form-group">
							<div class="form-row">
...

											{
												...
												try {
													...
													ps = con.prepareStatement(
															"select count(*) AS contaBacanga from votacao_4_dia where grupoa_1 = 'BACANGA(Edmilson França)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
								...
								<div class="col-md-5 p-3 text-center">
									<input type="hidden" name="data_votacao_4_dia" value="<%=dataStr%>">
									...
									<div class="progress">
										<%
											{
												...
												try {
													...
													con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
															"252107");
													ps = con.prepareStatement(
															"select count(*) AS contaGapara from votacao_4_dia where grupoa_1 = 'GAPARA(Roberto Costa)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
										...
										<div class="progress-bar" role="progressbar" aria-valuemin="0"
											aria-valuemax="100"><%=rs.getString("contaGapara")%></div>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="form-row">
											...
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaJardim from votacao_4_dia where grupoa_2 = 'JARDIM AMERICA(José Carlos Ribeiro)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
									...
									<div class="col-md-5 p-3 text-center">
										...
										<div class="progress">
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaAurora from votacao_4_dia where grupoa_2 = 'AURORA(Eduardo Verde)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
											...
											<div class="progress-bar" role="progressbar"
												aria-valuemin="0" aria-valuemax="100"><%=rs.getString("contaAurora")%></div>
										</div>
									</div>
								</div>
							</div>
												...
												<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaTuru from votacao_4_dia where grupob_1 = 'TURU(Alerrandro Barbosa)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
												...
												<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaMauro from votacao_4_dia where grupob_1 = 'MAURO FECURY(José Matias)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
									...
									<div class="form-group">
										<div class="form-row">
													...
													<%
														{
															...
															try {
																...
																con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																		"252107");
																ps = con.prepareStatement(
																		"select count(*) AS contaSaoCristovao from votacao_4_dia where grupob_2 = 'SÃO CRISTOVÃO(Carlos Braga)'");
																rs = ps.executeQuery();
																rs.next();
																rs = ps.executeQuery();
											...
											<div class="col-md-5 p-3 text-center">
												...
												<input class="form-check-input" type="radio" name="grupob_2"
													value="SANTA CRUZ(Antonio Rubens)">SANTA CRUZ (Antonio Rubens)<br>
												<div class="progress">
													<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaSanta from votacao_4_dia where grupob_2 = 'SANTA CRUZ(Antonio Rubens)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
														...
														<%
															{
																...
																try {
																	...
																	con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																			"252107");
																	ps = con.prepareStatement(
																			"select count(*) AS contaItapera from votacao_4_dia where grupoc_1 = 'ITAPERA(Rosmarindo)'");
																	rs = ps.executeQuery();
																	rs.next();
																	rs = ps.executeQuery();
														...
														<%
															{
																...
																try {
																	...
																	con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																			"252107");
																	ps = con.prepareStatement(
																			"select count(*) AS contaParque from votacao_4_dia where grupoc_1 = 'PQ BOM MENINO(Evandro Lima)'");
																	rs = ps.executeQuery();
																	rs.next();
																	rs = ps.executeQuery();
															...
															<%
																{
																	...
																	try {
																		...
																		con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																				"252107");
																		ps = con.prepareStatement(
																				"select count(*) AS contaAnjo from votacao_4_dia where grupoc_2 = 'ANJO DA GUARDA(Jacques Lopes Botão)'");
																		rs = ps.executeQuery();
																		rs.next();
																		rs = ps.executeQuery();
															...
															<%
																{
																	...
																	try {
																		...
																		con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																				"252107");
																		ps = con.prepareStatement(
																				"select count(*) AS contaBom from votacao_4_dia where grupoc_2 = 'BOM JESUS(Ronilson Mendes)'");
																		rs = ps.executeQuery();
																		rs.next();
																		rs = ps.executeQuery();
