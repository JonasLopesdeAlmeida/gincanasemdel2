	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar4">
			<ul
				...
				<li class="nav-item"><a class="nav-link" href="equipessetimodia.jsp">7ª dia</a>
				</li>	
				<li class="nav-item"><a class="nav-link" href="#equipes">EQUIPES</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="#regras">Regras</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="equipesnonodia.jsp">9ª dia de votação</a>
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="bg-white mr-auto col-md-12">
					<h1 class="text-danger font-weight-bold">Campeonato de votação - 8ª dia </h1>
		...
		<div class="container">
			...
			<div class="row negrita">
				<div class="col-md-8 mx-auto">
					<form method="post" action="ServerVotacaoOitavoDia">
						<div class="form-group">
							<div class="form-row">
...

											{
												...
												try {
													...
													ps = con.prepareStatement(
															"select count(*) AS contaAlemanha from votacao_8_dia where grupod_1 = 'ALEMANHA(Antônio Mario)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
								...
								<div class="col-md-5 p-3 text-center">
									<input type="hidden" name="data_votacao_8_dia" value="<%=dataStr%>">
									...
									<div class="progress">
										<%
											{
												...
												try {
													...
													con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
															"252107");
													ps = con.prepareStatement(
															"select count(*) AS contaSao from votacao_8_dia where grupod_1 = 'SÃO CRISTOVÃO(José Cruz)'");
													rs = ps.executeQuery();
													rs.next();
													rs = ps.executeQuery();
										...
										<div class="progress-bar" role="progressbar" aria-valuemin="0"
											aria-valuemax="100"><%=rs.getString("contaSao")%></div>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="form-row">
											...
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaJardim from votacao_8_dia where grupod_2 = 'JARDIM AMERICA(Eduardo Braga)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
									...
									<div class="col-md-5 p-3 text-center">
										...
										<div class="progress">
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaFumace2 from votacao_8_dia where grupod_2 = 'FUMACÊ(Josias Rabelo)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
											...
											<div class="progress-bar" role="progressbar"
												aria-valuemin="0" aria-valuemax="100"><%=rs.getString("contaFumace2")%></div>
										</div>
									</div>
								</div>
							</div>
												...
												<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaSantaCruz from votacao_8_dia where grupoe_1 = 'SANTA CRUZ(Clayton Dias)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
											...
											<%
												{
													...
													try {
														...
														con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																"252107");
														ps = con.prepareStatement(
																"select count(*) AS contaVila from votacao_8_dia where grupod_2 = 'VILA EMBRATEL(Nilson Mendes)'");
														rs = ps.executeQuery();
														rs.next();
														rs = ps.executeQuery();
									...
									<div class="form-row">
											<div class="col-md-5 p-3 text-center">
												<input class="form-check-input" type="radio" name="grupoe_2"
													value="PQ DO BOM MENINO(Luis Augusto Bodinho)">PQ DO BOM MENINO (Luis Augusto Bodinho)<br>
												<div class="progress">
													<%
														{
															...
															try {
																...
																con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																		"252107");
																ps = con.prepareStatement(
																		"select count(*) AS contaParque2 from votacao_8_dia where grupoe_2 = 'PQ DO BOM MENINO(Luis Augusto Bodinho)'");
																rs = ps.executeQuery();
																rs.next();
																rs = ps.executeQuery();
													...
													<div class="progress-bar" role="progressbar"
														aria-valuemin="0" aria-valuemax="100"><%=rs.getString("contaParque2")%></div>
												</div>
											</div>
													...
													<%
													{
														...
														try {
															...
															con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																	"252107");
															ps = con.prepareStatement(
																	"select count(*) AS contaCohab1 from votacao_8_dia where grupoe_2 = 'COHAB(Whasington Duarte)'");
															rs = ps.executeQuery();
															rs.next();
															rs = ps.executeQuery();
														...
														<%
															{
																...
																try {
																	...
																	con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																			"252107");
																	ps = con.prepareStatement(
																			"select count(*) AS contaVila2 from votacao_8_dia where grupof_1 = 'VILA EMBRATEL(Adilson de Jesus)'");
																	rs = ps.executeQuery();
																	rs.next();
																	rs = ps.executeQuery();
														...
														<%
															{
																...
																try {
																	...
																	con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																			"252107");
																	ps = con.prepareStatement(
																			"select count(*) AS contaQuebra from votacao_8_dia where grupof_1 = 'QUEBRA POTE(Francisco Silva Cigano)'");
																	rs = ps.executeQuery();
																	rs.next();
																	rs = ps.executeQuery();
												...
												<div class="form-row">
													<div class="col-md-5 p-3 text-center">
														...
														<div class="progress">
															<%
																{
																	...
																	try {
																		...
																		con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																				"252107");
																		ps = con.prepareStatement(
																				"select count(*) AS contaJanaina from votacao_8_dia where grupof_2 = 'JANAINA(Cristiane Coelho)'");
																		rs = ps.executeQuery();
																		rs.next();
																		rs = ps.executeQuery();
															...
															<div class="progress-bar" role="progressbar"
																aria-valuemin="0" aria-valuemax="100"><%=rs.getString("contaJanaina")%></div>
														</div>
													</div>
															...
															<%
																{
																	...
																	try {
																		...
																		con = DriverManager.getConnection("jdbc:postgresql://localhost/bdgincanasemdel", "postgres",
																				"252107");
																		ps = con.prepareStatement(
																				"select count(*) AS contaCidade from votacao_8_dia where grupof_2 = 'CIDADE OPERARIA(Francisco Aguiar Chicão)'");
																		rs = ps.executeQuery();
																		rs.next();
																		rs = ps.executeQuery();
